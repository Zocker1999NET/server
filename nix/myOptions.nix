...
let
  ...
  gpg_keys = {
    myKey = {
      fingerprint = "73D09948B2392D688A45DC8393E1BD26F6B02FB7";
      path = ./../extras/gpg_myKey.gpg;
    };
    archiveKey = {
      fingerprint = "19C17AF30A1152D473A3849C28279F3E0A444E63";
      path = ./../extras/gpg_archiveKey.gpg;
    };
  };
in
{
